...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Agux's Non Linear Plot Regressor", pos = wx.Point( -1,-1 ), size = wx.Size( 1286,1331 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		bSizer22.Add( self.m_staticText8, 1, wx.ALL, 5 )

		self.m_button6 = wx.Button( self.m_panel1, wx.ID_ANY, u"About this app", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer22.Add( self.m_button6, 0, wx.ALL, 5 )
		...
		bSizer25.Add( self.m_staticText121, 0, wx.ALL, 5 )
		...
		bSizer25.Add( bSizer12, 1, wx.EXPAND, 5 )


		bSizer4.Add( bSizer25, 0, wx.EXPAND, 5 )

		m_radioBox5Choices = [ u"Yes", u"No" ]
		self.m_radioBox5 = wx.RadioBox( self.m_panel1, wx.ID_ANY, u"Constant errors?", wx.DefaultPosition, wx.DefaultSize, m_radioBox5Choices, 2, wx.RA_SPECIFY_COLS )
		self.m_radioBox5.SetSelection( 1 )
		bSizer4.Add( self.m_radioBox5, 0, wx.ALL, 5 )
		...
		self.m_staticText40 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"Constant absolute errors for X and Y", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText40.Wrap( -1 )

		self.m_staticText40.Hide()

		bSizer17.Add( self.m_staticText40, 0, wx.ALL, 5 )
		...
		self.m_panel8 = wx.Panel( self.m_panel1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		...
		bSizer21.Add( self.m_textCtrl6, 1, wx.ALL|wx.EXPAND, 5 )
		...
		bSizer21.Add( self.m_textCtrl9, 1, wx.ALL|wx.EXPAND, 5 )
		...
		bSizer21.Add( self.m_textCtrl11, 1, wx.ALL|wx.EXPAND, 5 )


		bSizer3.Add( bSizer21, 1, wx.EXPAND, 5 )


		self.m_panel2.SetSizer( bSizer3 )
		self.m_panel2.Layout()
		bSizer3.Fit( self.m_panel2 )
		self.m_splitter1.SplitVertically( self.m_panel1, self.m_panel2, -1 )
		...
		self.m_button6.Bind( wx.EVT_BUTTON, self.wx_about_button )
		...
		self.m_radioBox5.Bind( wx.EVT_RADIOBOX, self.wx_change_errors )
...
class MyDialog1 ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText20 = wx.StaticText( self, wx.ID_ANY, u"- Expression: You'll have to use python and numpy syntax for the expression to be recognized. \nYou can use up to 25 parameters (standard alphabet except \"x\" character), and use them in alphabetical order. For example you could use \"a,b,c\" but not \"a,b,d\" or \"c,b,a\"\n", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText20.Wrap( -1 )
...
class MyDialog2 ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText34 = wx.StaticText( self, wx.ID_ANY, u"About this App", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText35 = wx.StaticText( self, wx.ID_ANY, u"- Version 1.1.0", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText35.Wrap( -1 )

		bSizer23.Add( self.m_staticText35, 0, wx.ALL, 5 )

		self.m_staticText32 = wx.StaticText( self, wx.ID_ANY, u"- Made with love for nerds by Agustín Alejo García 2022", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText32.Wrap( -1 )

		bSizer23.Add( self.m_staticText32, 0, wx.ALL, 5 )

		self.m_staticText33 = wx.StaticText( self, wx.ID_ANY, u"- From University of Buenos Aires - Argentina, Faculty of Exact and Natural Sciences", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText33.Wrap( -1 )

		bSizer23.Add( self.m_staticText33, 0, wx.ALL, 5 )

		self.m_staticText36 = wx.StaticText( self, wx.ID_ANY, u"- Contact: aguxgarcia@hotmail.com", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText37 = wx.StaticText( self, wx.ID_ANY, u"- GitHub: ", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText37.Wrap( -1 )

		bSizer24.Add( self.m_staticText37, 0, wx.ALL, 5 )

		self.m_hyperlink2 = wx.adv.HyperlinkCtrl( self, wx.ID_ANY, u"https://github.com/aguxone", u"https://github.com/aguxone", wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
		bSizer24.Add( self.m_hyperlink2, 0, wx.ALL, 5 )


		bSizer23.Add( bSizer24, 0, 0, 5 )

		self.m_staticText39 = wx.StaticText( self, wx.ID_ANY, u"\nThis app is open source and free for personal or educational use.\nBut it's also free to say thanks and reference\nthe author if you use it or find it useful for any use case.", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText39.Wrap( -1 )

		bSizer23.Add( self.m_staticText39, 0, wx.ALL|wx.EXPAND, 5 )
